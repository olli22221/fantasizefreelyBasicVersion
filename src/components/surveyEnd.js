...
function SurveyEndPage() {
    ...
    const surveyJson = {
       ...
       
      {
        ...
        type: "text",
        name: "What do you think of the scores you received?",
        title: "What do you think of the scores you received?",
        isRequired: true
      },
      {
                
        type: "text",
        name: "Do you think you progressed with your scores?",
        title: "Do you think you progressed with your scores?",
        isRequired: true
      },
      {
                
        type: "text",
        name: "How did you like the Musicat's graphical prediction?",
        title: "How did you like the Musicat's graphical prediction?",
        isRequired: true
      },
      {
                
        type: "text",
        name: "Did you find the scores to be useful?",
        title: "Did you find the scores to be useful?",
        isRequired: true
      },
      {
    ...
    const alertResults = useCallback((sender) => {
        ...
        axios.post('https://fantasifreely.de/'+"submitSurveyBasic",JSON.stringify(payload), {
            headers: {
